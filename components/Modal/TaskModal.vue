  ...
  <div class="Modal">
    <div class="icon-box">
      <div class="edit" @click="editEvent">
        <svg focusable="false" width="24" height="24" viewBox="0 0 24 24" class=" NMm5M"><path d="M20.41 4.94l-1.35-1.35c-.78-.78-2.05-.78-2.83 0L3 16.82V21h4.18L20.41 7.77c.79-.78.79-2.05 0-2.83zm-14 14.12L5 19v-1.36l9.82-9.82 1.41 1.41-9.82 9.83z"></path></svg>
      </div>
      <div class="delete-task" @click="deleteEvent">
        <svg focusable="false" width="24" height="24" viewBox="0 0 24 24" class=" NMm5M"><path d="M15 4V3H9v1H4v2h1v13c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V6h1V4h-5zm2 15H7V6h10v13z"></path><path d="M9 8h2v9H9zm4 0h2v9h-2z"></path></svg>
      </div>
    ...
    <div class="event-container">
      ...
      <div class="event_desc">
        <div class="desc_image">
          <svg xmlns="http://www.w3.org/2000/svg" height="24"  viewBox="0 -960 960 960" width="48"><path d="M319-250h322v-60H319v60Zm0-170h322v-60H319v60ZM220-80q-24 0-42-18t-18-42v-680q0-24 18-42t42-18h361l219 219v521q0 24-18 42t-42 18H220Zm331-554v-186H220v680h520v-494H551ZM220-820v186-186 680-680Z"/></svg>
        </div>
        <div class="desc_text">
...
<script setup>
  ...
  const deleteEvent = async() => {
    if(props.event.startTime){
      const deleteTask = await fetch(`http://localhost:3000/api/event/${props.event._id}`, {
        method: 'DELETE',
      });
    ...
    const deleteTask = await fetch(`http://localhost:3000/api/eventhour/${props.event._id}`, {
      method: 'DELETE',
    });
    if(deleteTask.status === 200)
    emit("deleteEvent", props.event._id);
